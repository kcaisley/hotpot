...
\centering\includegraphics[width=\textwidth,height=.83\textheight,keepaspectratio]{assets/workshop-schedule.pdf}
\end{frame}
...
\centering\includegraphics[width=\linewidth]{assets/arithmeum-house.jpg}
\end{column}
\end{columns}
\vspace{10pt}
