...
\centering\includegraphics[width=\textwidth,height=.83\textheight,keepaspectratio]{assets/workshop-flow.pdf}
\end{frame}
...
\begin{column}{.45\textwidth}\centering\includegraphics[width=\linewidth]{assets/inverter.pdf}\end{column}
...
\begin{columns}[c,onlytextwidth]\begin{column}{.48\textwidth}\centering\includegraphics[width=\linewidth,height=.73\textheight,keepaspectratio]{assets/spice-homepage.png}\end{column}\begin{column}{.48\textwidth}
...
\begin{columns}[c,onlytextwidth]
\begin{column}{.35\textwidth}\centering\includegraphics[width=\linewidth,height=.69\textheight,keepaspectratio]{assets/inverter-cmos.pdf}\end{column}
...
\slidesource{\href{https://github.com/nturley/netlistsvg}{netlistsvg}}
\begin{columns}[c,onlytextwidth]
\begin{column}{.45\textwidth}\centering\includegraphics[width=\linewidth]{assets/nand.pdf}\end{column}
...
\slidesource{\href{https://github.com/The-OpenROAD-Project/OpenROAD-flow-scripts/blob/master/flow/platforms/nangate45/cdl/NangateOpenCellLibrary.cdl}{Cell SPICE}}
\begin{columns}[c,onlytextwidth]
\begin{column}{.35\textwidth}\centering\includegraphics[width=\linewidth,height=.74\textheight,keepaspectratio]{assets/nand-cmos.pdf}\end{column}
...
\slidesource{\href{https://github.com/nturley/netlistsvg}{netlistsvg}}
\begin{columns}[c,onlytextwidth]
\begin{column}{.46\textwidth}\centering\includegraphics[width=\linewidth]{assets/top.pdf}\end{column}
...
\slidesource{\href{https://github.com/nturley/netlistsvg}{netlistsvg}}
\centering\includegraphics[width=\linewidth,height=.81\textheight,keepaspectratio]{assets/top-detail.pdf}
\end{frame}
...
\centering\includegraphics[width=\linewidth,height=.81\textheight,keepaspectratio]{assets/top-opendb.pdf}
\end{frame}
...
\centering\includegraphics[height=.81\textheight]{assets/cmos-cross-section.pdf}
\end{column}
\begin{column}{.49\textwidth}
\centering\includegraphics[height=.73\textheight]{assets/dmc65-layout.png}\\[3pt]
...
\fcolorbox{black}{white}{\includegraphics[height=.68\textheight]{assets/lefdef-cover.png}}
\end{column}
