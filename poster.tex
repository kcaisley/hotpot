...
\begin{scope}[shift={(current page.north west)}]
  ...
  \node[anchor=north east,inner sep=0] at (196mm,-13mm) {\includegraphics[width=39mm]{poster-assets/uni-bonn-logo.pdf}};
  ...
  % The completed routed design is the main visual.
  \node[anchor=center,inner sep=0] at (105mm,-130mm) {\includegraphics[height=112mm,trim=250 30 250 30,clip]{images/design.png}};

  % Workshop topics and OpenROAD project link.
  ...
  \node[anchor=north,inner sep=0] at (167mm,-210mm) {\includegraphics[width=50mm]{qr.png}};
