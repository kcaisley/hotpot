...
\begin{columns}[c,onlytextwidth]
\begin{column}{.49\textwidth}\centering\includegraphics[height=.72\textheight]{layout/nand_cell_labeled.pdf}\end{column}
\begin{column}{.49\textwidth}\centering\includegraphics[height=.72\textheight]{layout/inv_cell_labeled.pdf}\end{column}
\end{columns}
...
\centering\includegraphics[height=.82\textheight]{layout/pair_full_labeled.pdf}
\end{frame}
...
\centering\includegraphics[height=.82\textheight]{layout/pair_metal_labeled.pdf}
\end{frame}
...
\centering\includegraphics[height=.82\textheight]{layout/pair_pins_labeled.pdf}
\end{frame}
