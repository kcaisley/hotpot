...
\begin{scope}[shift={(current page.north west)}]
  ...
  \node[anchor=north east,inner sep=0] at (196mm,-13mm) {\includegraphics[width=39mm]{uni-bonn-logo.pdf}};
  ...
  \node[anchor=center,inner sep=0] at (105mm,-130mm) {\includegraphics[height=112mm]{chip-layout.png}};
